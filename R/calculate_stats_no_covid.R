calculate_stats_no_covid <- function(SAR_mpa){
  ...
  SAR_stats_ratio <- SAR_stats_no_covid %>%
    group_by(id_iucn) %>%
  ...
  SAR_stats_final_no_covid <- SAR_stats_no_covid %>%
  ...
  return(SAR_stats_final_no_covid)
